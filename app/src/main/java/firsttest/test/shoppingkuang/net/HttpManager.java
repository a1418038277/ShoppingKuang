package firsttest.test.shoppingkuang.net;
...
import firsttest.test.shoppingkuang.api.ShopApi;
...
public class HttpManager {
    ...
    public ShopApi getService(){
        if(serviceApi == null){
            serviceApi = getRetrofit(ShopApi.BASE_URL).create(ShopApi.class);
        }
        return serviceApi;
    }
