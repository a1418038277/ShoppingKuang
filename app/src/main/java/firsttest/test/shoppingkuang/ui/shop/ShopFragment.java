...
import firsttest.test.shoppingkuang.model.shop.Car.CarListAdapter;
...
import firsttest.test.shoppingkuang.presenter.home.car.CarPresenter;
import firsttest.test.shoppingkuang.utils.SpUtils;
import io.realm.RealmMigration;

public class ShopFragment extends BaseFragment<ICar.Presenter> implements ICar.View {
    ...
    public void getCarReturn(CarBean carBean) {
        ...
        recyGood.addItemDecoration(new DividerItemDecoration(getContext(), DividerItemDecoration.VERTICAL));
        CarListAdapter carListAdapter = new CarListAdapter(getContext(), carBean.getData().getCartList());
        recyGood.setAdapter(carListAdapter);
